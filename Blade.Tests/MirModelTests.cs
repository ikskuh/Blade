...
public class MirModelTests
{
    ...
    public void RewriteUses_CoversMirInstructionVariants()
    {
        ...
        MirCallInstruction call = new(v0, BuiltinTypes.U32, new FunctionSymbol("callee", IrTestFactory.CreateFunctionDeclarationSyntax("callee"), FunctionKind.Default, isTopLevel: false, storageClass: null, FunctionInliningPolicy.Default, SourceSpan.Synthetic()), [v1, v2], Span);
        ...
        MirYieldToInstruction yieldTo = new(new FunctionSymbol("pin", IrTestFactory.CreateFunctionDeclarationSyntax("pin"), FunctionKind.Default, isTopLevel: false, storageClass: null, FunctionInliningPolicy.Default, SourceSpan.Synthetic()), [v1, v2], Span);
