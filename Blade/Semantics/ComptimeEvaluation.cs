    ...
    Func<FunctionSymbol, ComptimeSupportResult> supportResolver)
{
        ...
        Dictionary<Symbol, ComptimeResult> callerFrame)
    {
        ...
        if (body is null)
            return new ComptimeResult(ComptimeFailureKind.NotEvaluable, call.Span, $"function body for '{call.Function.Name}' is not stable enough for comptime evaluation during binding.");
