...
public static class SyntaxFacts
{
    private static readonly FrozenDictionary<string, TokenKind> Keywords = new Dictionary<string, TokenKind>
    {
        ...
        ["layout"] = TokenKind.LayoutKeyword,
        ["task"] = TokenKind.TaskKeyword,
        ["spawn"] = TokenKind.SpawnKeyword,
        ["spawnpair"] = TokenKind.SpawnpairKeyword,
    ...
    public static string? GetText(TokenKind kind) => kind switch
    {
        ...
        TokenKind.LayoutKeyword => "layout",
        TokenKind.TaskKeyword => "task",
        TokenKind.SpawnKeyword => "spawn",
        TokenKind.SpawnpairKeyword => "spawnpair",
